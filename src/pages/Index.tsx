      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center space-y-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Welcome to our mentorship platform where experienced professionals and
            eager learners come together to foster growth and knowledge sharing.
          </p>
        ...
        <div className="mt-24 grid md:grid-cols-3 gap-8">
          <div className="p-6 bg-white rounded-lg shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600">
              Connect with industry professionals who can guide you through your
              career journey.
            </p>
          </div>
          <div className="p-6 bg-white rounded-lg shadow-sm border border-gray-100">
